...
public class HangFrame extends javax.swing.JFrame {
    ...
    public HangFrame() {
        ...
        list = hangService.getAll();
        loadData(list, currentPage);
    }

    private void setTotalPage() {
        int totalItem = hangService.getAll().size();
    ...
    /**
     *
     * @param list: Danh sách các danh mục
     * @param page: phân trang, trang thứ
     */
    private void loadData(List<Hang> list, int page) {
        dtm.setRowCount(0);
        int limit = page * rowCountPage;
        int totalItem = list.size();
        lblPage.setText("Trang " + currentPage + "/" + totalPage);
        for (int start = (page - 1) * rowCountPage; start < totalItem; start++) {
            Hang hang = list.get(start);
    ...
    private Hang getToTable(int selectedRow) {
        int index = (currentPage - 1) * rowCountPage + selectedRow;
        return hangService.getAll().get(index);
    }
    ...
    private void initComponents() {
        ...
        tblDanhMuc.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (getForm() == null) {
            ...
            String thongBao = hangService.add(getForm());
            list = hangService.getAll();
            loadData(hangService.getAll(), currentPage);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            Hang hang = new Hang();
            hang.setId(getToTable(selectedRow).getId());
            hang.setName(txtTen.getText());
            String thongBao = hangService.update(hang);
            list = hangService.getAll();
            loadData(list, currentPage);
            JOptionPane.showMessageDialog(this, thongBao);
        }
    ...
    private void tblDanhMucMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDanhMucMouseClicked
        ...
        int selectedRow = tblDanhMuc.getSelectedRow();
        int index = (currentPage - 1) * rowCountPage + selectedRow;
        txtTen.setText(hangService.getAll().get(index).getName());
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        List<Hang> searchList = new ArrayList<>();
        for (Hang hang : hangService.getAll()) {
            if (hang.getId().toLowerCase().contains(search) || hang.getName().toLowerCase().contains(search)) {
                searchList.add(hang);
            }
        }
        list = searchList;
